...
const Cs114observationform = ({ open, handleClose }) => {
  ...
  const onSubmit = (data) => {
    ...
    fetch('http://localhost:4000/Cs114observationform', {
      method: 'POST',
      body: formData
    })
  ...
  return (
    <Dialog open={open} onClose={handleClose} maxWidth='lg'>
      <DialogTitle align='center'>CS114-OBSERVATION FORM </DialogTitle>
      <DialogContent>
...
export default Cs114observationform;
...
//                   <TableCell align="center">Iteration</TableCell>
//                   <TableCell align="center">Remarks</TableCell>
//                   {/* <TableCell><Button variant="text" color="primary" onClick={handleAddRow}>
//                     +
//                   </Button> </TableCell> */}
//                   <TableCell align="center">
//                     <IconButton
